...
urlpatterns = [
    ...
    path('<int:pk>/hop-dong/', views.employee_contracts, name='employee_contracts'),

    # Contract URLs
    path('hop-dong/', views.contract_list, name='contract_list'),
    path('hop-dong/them/', views.contract_create, name='contract_create'),
    # Thêm URL pattern cho contract_create_general
    path('hop-dong/them-moi/', views.contract_create_general, name='contract_create_general'),
    ...
    # Thêm URL pattern mới cho chức năng xóa hợp đồng
