...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('month', models.IntegerField(default=1, verbose_name='Tháng')),
                ...
                ('standard_workdays', models.DecimalField(decimal_places=2, default=24, max_digits=5, verbose_name='Số công chuẩn')),
